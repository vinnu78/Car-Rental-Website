        ...
        <div class="cd-faq-items">
            <ul id="basics" class="cd-faq-group">
                <li class="cd-faq-title">
                    <h2 style="color:black">Basics</h2>
                </li>
                <li>
                    <a class="cd-faq-trigger" href="#0">How do I pay for my Rental?</a>
                    <div class="cd-faq-content">
                        <p>Car Rental gladly accepts Debit Card. Personal Checks are also accepted providing you purchase CDW and Theft Protection on your rental.
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>One of the many great things about DP Car Rental is our rental rates and services are guaranteed to be the very best in the industry. If you come across a lower price from a competitor and the rate is on a comparable vehicle including the same terms, locations, and rental car fees we will be glad to beat the price for you. Please complete our Guaranteed Best Rate form if you have found a better rate with one of our competitors.</div>
                    <!-- cd-faq-content -->
                </li>
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>A driving license is needed for our company's security.</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>
            ...
            <ul id="membership" class="cd-faq-group">
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>You can go directly to our registration form.And provide some basic information like Name,Email,Password,Phone Number,Driving License Number,DL Image</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>Once you sign-up,you have to varify your email address after varified we will re-direct you to the log in screen. When you are logged in, you will see homepage. If you already have set up an account but have logged out, you can either click on the 'Log-In' button on our menu bar which takes you to our log-in page or, if you are on our home page, you can use the log-in area on it.</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>Your privacy is very important to us. As long as you do not share your email and password with others, no one will be able to see or edit your personal information.</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>If you share your computer with others, you should log-out when you are done with your session on our web site. Taking this steps will ensure that the next person using the computer will not have access to your account.</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>
                <li>
                    <a class="cd-faq-trigger" href="#0">Is my debit card information stored in my account?</a>
                    <div class="cd-faq-content">
                        <p>No.We do not store any debit card information in your account.</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>
            </ul>
